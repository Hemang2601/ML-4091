...
iris=pd.read_csv("C:/Users/student/Downloads/ML-4091/30-06-2026/iris.csv")

# define data and target variables
y = iris["Species"]
x = iris[["SepalLengthCm", "SepalWidthCm", "PetalLengthCm", "PetalWidthCm"]]  # Common Kaggle format
